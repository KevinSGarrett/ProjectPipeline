...
- Honest external gates for GitHub/Jira (read probes only; write/readback remains blocked)
...
| `github_jira_governance` | `BLOCKED_EXTERNAL` (read probes may succeed; governed write/readback not claimed) |
