CREATE TABLE IF NOT EXISTS budget_limits (
    ...
    hard_cap_microunits BIGINT NOT NULL CHECK (hard_cap_microunits >= 0),
    protected_reserve_microunits BIGINT NOT NULL CHECK (protected_reserve_microunits >= 0),
...
CREATE TABLE IF NOT EXISTS budget_ledger (
    ...
    cash_microunits BIGINT NOT NULL CHECK (cash_microunits >= 0),
    shadow_cost_microunits BIGINT NOT NULL CHECK (shadow_cost_microunits >= 0),
    payload_json JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS budget_spend_leases (
    ...
    consumed_microunits BIGINT NOT NULL CHECK (consumed_microunits >= 0),
...
CREATE TABLE IF NOT EXISTS budget_anomalies (
    ...
    block_new_paid_work BOOLEAN NOT NULL,
    payload_json JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS budget_forecasts (
    ...
    task_class TEXT,
    provider_id TEXT,
    p50_microunits BIGINT NOT NULL CHECK (p50_microunits >= 0),
    p90_microunits BIGINT NOT NULL CHECK (p90_microunits >= 0),
    payload_json JSONB NOT NULL,
