...
- Assigned overlays: FORCED_PROCESS_TERMINATION, PROVIDER_API_OUTAGE, GITHUB_JIRA_UNKNOWN_WRITE_OUTCOME, REDUCED_BUDGET, MID_PROJECT_REQUIREMENT_CHANGE, PROMPT_INJECTION_DOCUMENT, SYNTHETIC_SECRET_TRAP, VULNERABLE_DEPENDENCY, HUMAN_REQUIRED_BLOCKER, BROKEN_MIGRATION_ROLLBACK, CONCURRENT_WORKSPACE_CONFLICT, NETWORK_LOSS, DATABASE_SERVICE_FAILURE, INCORRECT_PREEXISTING_DONE_STATE
- Repository shape: THREE_REPOSITORIES
